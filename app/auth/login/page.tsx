...
export default function LoginPage() {
  ...
  const [mode, setMode] = useState("user") // default fallback
  const router = useRouter()

  useEffect(() => {
    const selectedMode = localStorage.getItem("mode")
    if (selectedMode === "professional" || selectedMode === "user") {
        ...
        >
          <div className="rounded-2xl border bg-card/50 backdrop-blur-sm shadow-lg p-6 md:p-8">
            ...
            <form className="space-y-6" onSubmit={handleSignIn}>
              ...
              <Button type="submit" className="w-full rounded-xl group relative overflow-hidden">
